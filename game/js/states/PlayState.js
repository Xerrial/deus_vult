...
Deusvult.PlayState.prototype = Object.create(Phaser.State.prototype);
Deusvult.PlayState.prototype.constructor = Deusvult.PlayState;

Deusvult.PlayState.prototype.init = function (level_data) {
    "use strict";
    var tileset_index;
...
Deusvult.PlayState.prototype.create = function () {
    "use strict";
    ...
    this.game.user_input = this.game.plugins.add(Deusvult.UserInput, this, JSON.parse(this.game.cache.getText("user_input")));
    
    this.init_hud();
};

Deusvult.PlayState.prototype.create_object = function (object) {
    "use strict";
...
Deusvult.PlayState.prototype.init_hud = function () {
    "use strict";
    ...
    player1_lives = new Deusvult.Lives(this, "lives", player1_lives_position, player1_lives_properties);
    ...
    player2_lives = new Deusvult.Lives(this, "lives", player2_lives_position, player2_lives_properties);
};

Deusvult.PlayState.prototype.show_game_over = function () {
    "use strict";
...
Deusvult.PlayState.prototype.create_game_over_panel = function (position, texture, text_style) {
    "use strict";
    ...
    game_over_panel = new Deusvult.GameOverPanel(this, "game_over_panel", position, game_over_panel_properties);
