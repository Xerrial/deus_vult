...
Deusvult.Player = function (game_state, name, position, properties) {
    "use strict";
...
Deusvult.Player.prototype = Object.create(Deusvult.Prefab.prototype);
Deusvult.Player.prototype.constructor = Deusvult.Player;

Deusvult.Player.prototype.update = function () {
    "use strict";
...
Deusvult.Player.prototype.change_movement = function (direction_x, direction_y, move) {
    "use strict";
    if (direction_x < 0) {
...
Deusvult.Player.prototype.try_dropping_bomb = function () {
    "use strict";
    var colliding_bombs;
...
Deusvult.Player.prototype.drop_bomb = function () {
    "use strict";
    ...
    bomb = Deusvult.create_prefab_from_pool(this.game_state.groups.bombs, Deusvult.Bomb.prototype.constructor, this.game_state, bomb_name, bomb_position, bomb_properties);
    this.current_bomb_index += 1;
};

Deusvult.Player.prototype.die = function () {
    "use strict";
