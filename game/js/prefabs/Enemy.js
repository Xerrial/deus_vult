...
Deusvult.Enemy = function (game_state, name, position, properties) {
    "use strict";
...
Deusvult.Enemy.prototype = Object.create(Deusvult.Prefab.prototype);
Deusvult.Enemy.prototype.constructor = Deusvult.Enemy;

Deusvult.Enemy.prototype.update = function () {
    "use strict";
    var new_position;
...
Deusvult.Enemy.prototype.switch_direction = function () {
    "use strict";
    if (this.axis === "x") {
